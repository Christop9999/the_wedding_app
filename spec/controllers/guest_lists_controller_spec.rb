...
describe GuestListsController do
  ...
  describe "GET index" do
    it "assigns all guest_lists as @guest_lists" do
      ...
      assigns(:guest_lists).should eq([guest_list])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested guest_list as @guest_list" do
      ...
      assigns(:guest_list).should eq(guest_list)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new guest_list as @guest_list" do
      ...
      assigns(:guest_list).should be_a_new(GuestList)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created guest_list as @guest_list" do
        post :create, {:guest_list => valid_attributes}, valid_session
        assigns(:guest_list).should be_a(GuestList)
        assigns(:guest_list).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guest_list as @guest_list" do
        ...
        post :create, {:guest_list => { "wedding" => "invalid value" }}, valid_session
        assigns(:guest_list).should be_a_new(GuestList)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guest_list" do
        guest_list = GuestList.create! valid_attributes
        # Assuming there are no other guest_lists in the database, this
        # specifies that the GuestList created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        GuestList.any_instance.should_receive(:update).with({ "wedding" => "" })
        put :update, {:id => guest_list.to_param, :guest_list => { "wedding" => "" }}, valid_session
      end
      ...
      it "redirects to the guest_list" do
        guest_list = GuestList.create! valid_attributes
        put :update, {:id => guest_list.to_param, :guest_list => valid_attributes}, valid_session
        response.should redirect_to(guest_list)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the guest_list as @guest_list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        GuestList.any_instance.stub(:save).and_return(false)
        put :update, {:id => guest_list.to_param, :guest_list => { "wedding" => "invalid value" }}, valid_session
        assigns(:guest_list).should eq(guest_list)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the guest_lists list" do
      guest_list = GuestList.create! valid_attributes
      delete :destroy, {:id => guest_list.to_param}, valid_session
      response.should redirect_to(guest_lists_url)
    end
  end
